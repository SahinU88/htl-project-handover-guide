...
- linked to a tool which is available for me (e.g. github-project-boards, trello-boards, ...)
- included into this documentation as a csv/excel file
- ...

You just have to check if you fulfill the following requirements:

- the task name is visible
- a short description for the task is available
